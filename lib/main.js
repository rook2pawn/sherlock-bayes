...
var chartUI=makeChartUI(chart,200,250)
...
var pBars=makePBars(pDist,parseInt(chartUI[0][0].style.width),240,140)
...
var pDistReport=reportPDist(pDist,parseInt(chartUI[0][0].style.width),230,145)
